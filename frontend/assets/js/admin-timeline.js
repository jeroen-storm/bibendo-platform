...
class AdminTimelineDashboard {
    ...
    createFinalAssignmentAccordion(items) {
        // Field labels - exact text from email (without note references)
        const fieldLabels = {
            ...
            9: 'Voor de lancering van SneakSpot adviseren wij om...',
            10: 'Om meer jongeren naar SneakSpot te laten komen, zouden wij adviseren om ...'
        };
